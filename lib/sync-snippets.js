...
function detectIDEs() {
  ...
  return Array.from(detected); // NEVER "all"
}
...
(async () => {
  console.log('ℹ Node Shortcuts — snippet sync starting');
  ...
  console.log('✔ Node Shortcuts — sync complete');
})().catch(err => {
